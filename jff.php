        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <li><a class="dropdown-item" href="tranjokiff.php">Transaksi</a></li>
                ...
                <form method="post" enctype="multipart/form-data">
                                <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                        ...
                                        <h4 style = "font-family:courier">
                                            ...
                                            <div class="">
                                            <input type="text" class="form-control"  name="email" placeholder="Akun FB" />
                                            <br>
                                    ...
                                    <h4 style = "font-family:courier">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    ...
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminjokiff where id=1 ");
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminjokiff where id=2 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminjokiff where id=3 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                    ...
                                    <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                            ...
                                            <input type="hidden" name="setatus" value="Proses">
                                                <button type="submit" class="btn btn-danger" name="addnewbara">
                                                    Bayar
                                                </button>
                                            </div>
                                        </div>                                                                                                       
