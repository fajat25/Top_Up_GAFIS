            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="tranjokiml.php">Transaksi</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                    <img class="col-xl-12 mt-4" alt="cover" src="https://a.m.dana.id/resource/imgs/item-digital/games/mobile_legends.png">
                                        <div class="text-white mb-4">
                                            <div class="card-body">
                                                <h4 style = "font-family:courier">
                                                Mobile Legends Game Products
                                                </h4>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                        ...
                                        <h4 style = "font-family:courier">
                                            ...
                                            <div class="">
                                            <input type="text" class="form-control"  name="email" placeholder="Akun Moonton" />
                                            <br>
                                            <input type="text" class="form-control" name="password" placeholder="Passowrd" />
                                            <br>
                                            <h6 style = "font-family:courier">
                                                Masukan Nomor WA untuk menghubungi jika sudah selsai joki Contoh "85838678033" 11 nomor terakhir
                                                </h6>
                                            <input type="text" class="form-control" name="nomor" placeholder="8*********" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                    ...
                                    <h4 style = "font-family:courier">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    ...
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminjokiml where id=1 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                        <input type="radio" name="brandtype" id="1" class="hidebx" value="<?php echo $data['pesanan']; ?>">
                                                        <label for="1" class="lb1-radio">
                                                            <div class="display-box">
                                                                <div class="size"><?php echo $data['pesanan']; ?></div>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminjokiml where id=2 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                        <input type="radio" name="brandtype" id="2" class="hidebx" value="<?php echo $data['pesanan']; ?>">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminjokiml where id=3 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                        <input type="radio" name="brandtype" id="3" class="hidebx" value="<?php echo $data['pesanan']; ?>">
                                    ...
                                    <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                            <div class="card bg-light text-muted mb-4">
                                                ...
                                                <button type="submit" class="btn btn-danger" name="addnewbaran">
                                                    Bayar
                                                </button>
                                            </div>
                                        </div>                                                                                                       
