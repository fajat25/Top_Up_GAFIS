            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="trantopupml.php">Transaksi</a></li>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                        ...
                                        <h4 style = "font-family:courier">
                                            ...
                                            <input type="text" class="form-control" name="server" placeholder="12345" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                    ...
                                    <h4 style = "font-family:courier">
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    ...
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=1 ");
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=2 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=5 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=6 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=7 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=8 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                                ...
                                                <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                                    <div class="card bg-light text-muted mb-4">
                                                    <?php
                                                    $ambilsatudata = mysqli_query($conn,"select * from adminmltopup where id=9 ");
                                                    while($data=mysqli_fetch_array($ambilsatudata)){
                                                        ?>
                                    ...
                                    <div class="card navbar-dark bg-dark text-white mb-4 px-2">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-6 col-6">
                                            <div class="card bg-light text-muted mb-4">
                                                ...
                                                <button type="submit" class="btn btn-danger" name="addnewbarang">
                                                    Bayar
                                                </button>
                                            </div>
                                        </div>                                                                                                       
