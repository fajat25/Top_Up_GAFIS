        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-2">Data Produk Joki Free Fire</h1>
                    <div class="card mb-4">
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $ambilsemuadatastock = mysqli_query($conn,"select * from adminjokiff");
                                    $i = 1;
                                    while($data=mysqli_fetch_array($ambilsemuadatastock)){
                                        
                                        $namabarang = $data['pesanan'];
                                    ...
                                    <div class="modal fade" id="id<?=$id;?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <form action="editff.php" method="post">
