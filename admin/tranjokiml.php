        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-2">Transaksi Joki ML</h1>
                    <div class="card mb-4">
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $ambilsemuadatastock = mysqli_query($conn,"select * from jokiml");
                                    $i = 1;
                                    while($data=mysqli_fetch_array($ambilsemuadatastock)){
                                        ...
                                        if(null==$gambar){
                                            ...
                                            $img = '<img src="\proyek2/image/'.$gambar.'" class="zoomable">';
                                        }
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$namabarang;?></td>
                                        <td><?=$kat;?></td>
                                        <td><a class="btn btn-info" href="https://wa.me/+62<?=$ka;?>">Pesan</a></td>
                                        <td><?=$qty;?></td>
                                        <td><?=$sts;?></td>
                                        <td><?=$img;?></td>
                                    ...
                                    <div class="modal fade" id="id<?=$id;?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <form action="editjmlt.php" method="post">
                                                    <div class="modal-body">
                                                        <input type="hidden" class="form-control" name="id" value="<?=$id;?>">
                                                        <select name="setatus" class="form-control" value="<?=$sts;?>">
                                                            <option value='Proses'>Proses</option>
                                                            <option value='Selsai'>Selsai</option>
                                                        </select>
                                                        <br>
