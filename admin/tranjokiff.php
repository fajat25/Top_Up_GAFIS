        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-2">Transaksi Joki FF</h1>
                    <div class="card mb-4">
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $ambilsemuadatastock = mysqli_query($conn,"select * from jokiff");
                                    $i = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$namabarang;?></td>
                                        <td><?=$kat;?></td>
                                        <td> <a class="btn btn-info" href="https://wa.me/+62<?=$ka;?>">Pesan</a>
                                            </td>
                                        <td><?=$qty;?></td>
                                        <td><?=$sts;?></td>
                                        <td><?=$img;?></td>
                                    ...
                                    <div class="modal fade" id="id<?=$id;?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal body -->
                                                <form action="editjfft.php" method="post">
