                        ...
                        <div class="card-body">
                            <form method="POST" action="" class="form-inline">
                                <select name="Kat" class="form-control">
                                    <?php
                                        $query    =mysqli_query($conn, "select * from topupml GROUP BY jumlahdm ORDER BY jumlahdm");
                                ...
                                <table class="table table-bordered" id="mauexport">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['Kat'])) {
                                            ...
                                            $tamPeg=mysqli_query($conn, "select * from topupml where setatus='selsai' and jumlahdm='$unit_kerja' ORDER BY idcus DESC");
                                        } else { 
                                            if (isset($_POST['tangga'])) {
                                            $mulai=$_POST['tang'];
                                            $selsai=$_POST['tangg'];
                                            $tamPeg=mysqli_query($conn, "select * from topupml setatus='selsai' and tanggal BETWEEN '$mulai' and DATE_ADD('$selsai', INTERVAL 1 DAY) ORDER BY idcus DESC");
                                        } else {
                                            $tamPeg=mysqli_query($conn, "select * from topupml where setatus='selsai'");
                                        }
                                    }
                                            $i = 1;
